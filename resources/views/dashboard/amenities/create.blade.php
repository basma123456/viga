...
@section('content')
    <form class="form form-horizontal" action="{{route('dashboard.amenities.store')}}" method="post" enctype="multipart/form-data">
        @if ($errors->any())
        ...
        <div class="form-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 mx-auto">
                    <input type="text" id="name_ar" class="form-control" placeholder="@lang('amenity.name_en')" name="name_ar" value="{{old('name_ar')}}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 label-control" for="name_en">@lang('amenity.name_en')</label>
                <div class="col-md-9 mx-auto">
                    <input type="text" id="name_en" class="form-control" placeholder="@lang('amenity.name_en')" name="name_en" value="{{old('name_en')}}">
                </div>
            </div>
