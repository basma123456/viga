...
@section('content')
    <div class="utf_dashboard_content">
        <div id="titlebar" class="dashboard_gradient">
            <div class="row">
                <div class="col-md-12">
                    <h2> @lang('sidebar.create_sub_category')</h2>
                    <nav id="breadcrumbs">
                        <ul>
                            <li><a href="{{route('dashboard.home')}}">@lang('sidebar.home')</a></li>
                            <li>@lang('sidebar.create_sub_category')</li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="add_utf_listing_section margin-top-45">
                <div class="utf_add_listing_part_headline_part">
                    <h3><i class="sl sl-icon-plus"></i> @lang('sidebar.create_sub_category')</h3>
                </div>
                <form action="{{route("dashboard.sub_categories.store")}}" method="POST" enctype="multipart/form-data">
                   @csrf
                    ...
                    <div class="row with-forms margin-bottom-5">
                        <div class="col-md-6">
                            <h5>@lang('sub.name_en')</h5>
                            <input type="text" class="" name="name_en" id="name_en" placeholder="@lang('sub.name_en')" value="{{old('name_en')}}">
                           @error('name_en')
                            <div class="notification error closeable" >
                                <p>{{ $message }}</p>
                                <a class="close"></a>
                        ...
                        <div class="col-md-6">
                            <h5>@lang('sub.name_ar')</h5>
                            <input type="text" class="" name="name_ar" id="name_ar" placeholder="@lang('sub.name_ar')" value="{{old('name_ar')}}">
                            @error('name_ar')
                            <div class="notification error closeable" >
                                <p>{{ $message }}</p>
                                <a class="close"></a>
                    ...
                    <div class="row with-forms margin-bottom-5">
                        ...
                        <div class="col-md-4">
                            <h5>@lang('sub.meta_description')</h5>
                            <input type="text" class="" name="meta_desc" id="mete_desc" placeholder="@lang('sub.meta_description')" value="{{old('meta_desc')}}">
                            @error('meta_desc')
                            <div class="notification error closeable" >
                                <p>{{ $message }}</p>
                                <a class="close"></a>
                        ...
                        <div class="col-md-4">
                            <h5>@lang('sub.seo_title')</h5>
                            <input type="text" class="" name="seo" id="seo" placeholder="@lang('sub.seo_title')" value="{{old('seo')}}">
                            @error('seo')
                            <div class="notification error closeable" >
                                <p>{{ $message }}</p>
                                <a class="close"></a>
                    ...
                    <div class="row with-forms margin-bottom-5">
                        <div class="col-md-4">
                            <h5>@lang('sub.priority')</h5>
                            <input type="number" min="0" step="1" class="search-field" name="priority" id="priority" placeholder="@lang("sub.priority")" value="{{old('priority')}}">
                            @error('priority')
                            <div class="notification error closeable" >
                                <p>{{ $message }}</p>
                                <a class="close"></a>
                    ...
                    <div class="row with-forms margin-bottom-5">
                        <div class="col-md-4 utf_submit_section">
                            <div class="intro-search-field ">
                            <label  for="icon_map">@lang("sub.icon_map")</label>
                        ...
                        <div class="col-md-4 utf_submit_section">
                            <div class="intro-search-field ">
                                <label for="icon_category">@lang("sub.icon_category")</label>
