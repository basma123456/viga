...
@section('content')
    ...
    <form action="{{route("dashboard.prices.store")}}" method="post">
        ...
        {{method_field('post')}}
        <div class="form-body">
            <h4 class="form-section"><i class="la la-folder-open"></i> @lang('sidebar.create_price')</h4>
            <div class="form-group row">
                <label class="col-md-3 label-control" for="price">السعر</label>
                <div class="col-md-9 mx-auto">
                    <input type="text" id="price" class="form-control" name="price" placeholder=" السعر" value="{{old('price')}}">
                </div>
            </div>
            <div class="form-group row">
